...
Editor.prototype.setSelectedEnemy = function(index) {
    ...
    //console.log(this.enemies[this.selectedEnemy]);
...
function ajaxGetLevel(onSuccess) {
    ...
    */
    ...
    if(level_data) {
      ...
      localStorage.setItem('rapt-level', level_data);
      onSuccess(JSON.parse(level_data));
    }
}
...
function ajaxPutLevel(json, onSuccess) {
    ...
    */
    localStorage.setItem('rapt-level', json);
}
...
window.showOrHidePanels = showOrHidePanels;
