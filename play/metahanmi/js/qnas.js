let _qnas = [
    ...
    {
        type: '영어'.split(','),
        quiz: '다음 중 황금 거위는 무엇일까요?',
        answer: 'Golden Goose'.split(','),
        example: 'Golden Duck,Golden Chicken,Golden Swan'.split(','),
        year: 5,
        class: '새반 영어',
        by: 'Janet',
        role: '선생님',
    ...
    {
        type: '영어'.split(','),
        quiz: '숲 속의 노인으로 부터 황금 거위를 받은 사람은 누구일까요?',
        answer: 'Hans'.split(','),
        example: 'Fritz,Inkeeper,Daughter'.split(','),
        year: 5,
        class: '새반 영어',
        by: 'Janet',
        role: '선생님',
    ...
    {
        type: '영어'.split(','),
        quiz: '오거가 나타났음을 알 수 있는 소리, 오거는 어떤 소리를 낼까요?',
        answer: 'Fee Fi Fo Fum'.split(','),
        example: 'Ouch,Flop Flop,Quack Quack'.split(','),
        year: 4,
        class: '나무반 영어',
        by: 'Janet',
        role: '선생님',
    ...
    {
        type: '영어'.split(','),
        quiz: '미운 아기 오리가 토끼에게 한 말은?',
        answer: 'Do you want to play?'.split(','),
        example: 'Can I play with you?,You are ugly.,Go away!'.split(','),
        year: 4,
        class: '나무반 영어',
        by: 'Janet',
        role: '선생님',
    ...
    {
        type: '상식'.split(','),
        quiz: '나는 빨강색이고. 안에는 작은 구슬이 들어있고, 흔들면 소리가 나요. 나는 어떤 악기일까요?',
        answer: '마라카스'.split(','),
        example: '에그쉐이커,손목방울,클라베스'.split(','),
        year: 5,
        class: '오르프슐레',
        by: '박찬미',
        role: '선생님',
    ...
    {
        type: '상식'.split(','),
        quiz: '우쿨렐레 악기는 줄을 튕겨 연주해요. 몇개의 줄을 가지고 있을까요?',
        answer: '4'.split(','),
        example: '3,5,6'.split(','),
        year: 5,
        class: '오르프슐레',
    ...
    {
        type: '상식'.split(','),
        quiz: '두 개의 나무를 두드려 소리를 내는 악기는 무엇일까요?',
        answer: '클라베스'.split(','),
        example: '우드블럭,실로폰,우쿨렐레'.split(','),
        year: 5,
        class: '오르프슐레',
        by: '박찬미',
        role: '선생님',
    ...
    {
        type: '영양'.split(','),
        quiz: '나로 빨간색 케첩을 만들어요. 동그란 모양의 나는 누구일까요?',
        answer: '토마토'.split(','),
        example: '당근,감자'.split(','),
        year: 4,
        class: '꽃반 영양',
    ...
    {
        type: '상식'.split(','),
        quiz: '달에 있는 운석충돌구도 볼 수 있어요. 멀리 있는 것을 볼 수 있는 거에요. 이것은 무엇일까요?',
        answer: '망원경'.split(','),
    ...
    {
        type: '상식'.split(','),
        quiz: '굵기가 같은 거미줄과 철사를 당겼을 때 둘 중에 어떤 것이 잘 끊어지지 않을까요?',
        answer: '거미줄'.split(','),
        example: '철사'.split(','),
        year: 5,
        class: '까치반',
    ...
    {
        type: '엉뚱'.split(','),
        quiz: '겨울왕국에 나오는데 머리가 하얀 사람은? 항상 하나로 땋은 머리를 자주해요.',
        answer: '엘사'.split(','),
        example: '안나,올라프'.split(','),
        year: 5,
        class: '까치반',
        by: '정가온',
        role: '어린이',
    ...
    {
        type: '속담'.split(','),
        quiz: '"고래싸움에 ㅇㅇ등 터진다" 라는 속담이 있어요. ㅇㅇ에 들어갈 알맞은 말은 무엇일까요?',
        answer: '새우'.split(','),
        example: '랍스타,킹크랩,고래'.split(','),
        year: 5,
        class: '종달새반',
        by: '이도원',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '위기에 처했을 때 구조를 요청하는 신호는 무엇일까요?',
        answer: 'SOS'.split(','),
        example: 'SBS,SES'.split(','),
        year: 5,
        class: '종달새반',
        by: '이도원',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '라이트형제가 만든 최초의비행기 이름은?',
        answer: '플라이어1호'.split(','),
        example: 'f22,송호준호,팬텀전투기'.split(','),
        year: 5,
        class: '종달새반',
        by: '송호준',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '줄이 4개이고 활로 연주하는 악기는?',
        answer: '바이올린'.split(','),
        example: '탬버린,기타,트럼펫'.split(','),
        year: 4,
        class: '참나무반',
        by: '한의재에런',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '물감으로 빨강 노랑 파랑을 섞으면 무슨색이 될까?',
        answer: '검정색'.split(','),
        example: '갈색,흰색,투명색'.split(','),
        year: 4,
        class: '참나무반',
        by: '박시호',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '다음 중 파충류가 아닌 동물은 무엇일까요?',
        answer: '개구리'.split(','),
        example: '거북이,뱀,악어'.split(','),
        year: 4,
        class: '참나무반',
        by: '김현호',
        role: '어린이',
    ...
    {
        type: '숫자'.split(','),
        quiz: '임포스터가 변신을 하면 어떻게 될까요?',
        answer: '다른 어몽어스 크루원으로 변신해요.'.split(','),
        example: '임포스터로 변신해요,헬로카봇으로 변신해요,무지개 어몽어스로 변신해요'.split(','),
        year: 4,
        class: '소나무반',
        by: '박재이',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '타는 것고 있고 우리 몸에도 있고 먹는 과일도 있고 장난감으로도 있는 것은?',
        answer: '배'.split(','),
        example: '사과,차,방귀'.split(','),
        year: 3,
        class: '개나리반',
        by: '김보겸',
        role: '어린이',
    ...
    {
        type: '일상'.split(','),
        quiz: '이것은 탈것이에요. 까만색 줄에 매달려서 다녀요. 앞모습이 기차처럼 생겼어요. 사람들을 태우고 이쪽에서 저쪽까지 왔다 갔다 해요. 이것을 타고 있으면 창밖으로 똑같이 생긴 이것이 옆으로 계속 지나가요. 이것은 무엇일까요?',
        answer: '케이블카'.split(','),
        example: '하늘기차,범퍼카,비행기'.split(','),
        year: 3,
        class: '개나리반',
        by: '김지완',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '이건 집을 가지고 다녀요. 더듬이같이 생긴 코가 있어요. 그리고 느릿느릿 움직여요.',
        answer: '달팽이'.split(','),
        example: '기린,표범,코끼리'.split(','),
        year: 3,
        class: '진달래반',
        by: '전다빈',
        role: '어린이',
    ...
    {
        type: '상식'.split(','),
        quiz: '이것은 하늘에 있어요. 깜깜한 밤에 볼 수 있어요. 점점 뚱뚱해졌다가 다시 날씬해져요.',
        answer: '달'.split(','),
        example: '해,별'.split(','),
        year: 3,
        class: '진달래반',
    ...
    {
        type: '상식'.split(','),
        quiz: '나는 상상속의 동물입니다. 머리에 뿔이 달린 말을 닮은 동물입니다. 나는 누구일까요?',
        answer: '유니콘'.split(','),
        example: '페가수스,드래곤,피닉스'.split(','),
        year: 3,
        class: '해바라기반',
        by: '남주엘',
        role: '어린이',
