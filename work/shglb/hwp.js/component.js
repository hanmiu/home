(window.webpackJsonp = window.webpackJsonp || []).push([[3], {
    "0GMl": function(e, t, n) {
        ...
        Object.create;
        var u = new Map([["avi", "video/avi"], ["gif", "image/gif"], ["ico", "image/x-icon"], ["jpeg", "image/jpeg"], ["jpg", "image/jpeg"], ["mkv", "video/x-matroska"], ["mov", "video/quicktime"], ["mp4", "video/mp4"], ["pdf", "application/pdf"], ["png", "image/png"], ["zip", "application/zip"], ["doc", "application/msword"], ["docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"]]);
        function l(e, t) {
            var n = function(e) {
                var t = e.name;
        ...
        function f(e) {
            return o(this, void 0, void 0, (function() {
                return a(this, (function(t) {
                    return [2, (n = e,
                    n.dataTransfer && e.dataTransfer ? d(e.dataTransfer, e.type) : p(e))];
                    var n
                }
                ))
            }
        ...
        function d(e, t) {
            return o(this, void 0, void 0, (function() {
                ...
                return a(this, (function(r) {
                    switch (r.label) {
                    case 0:
                        return e.items ? (n = g(e.items).filter((function(e) {
                            return "file" === e.kind
                        }
                        )),
        ...
        function y(e) {
            ...
            return t && t.isDirectory ? O(t) : m(e)
        }
        function b(e) {
        ...
        function C(e, t) {
            var n = "application/x-moz-file" === e.type || D()(e, t);
            return [n, n ? null : F(t)]
        }
        function S(e, t, n) {
            if (x(e.size))
        ...
        function M() {
            ...
            return function(e) {
                ...
                return t.some((function(t) {
                    return !z(e) && t && t.apply(void 0, [e].concat(r)),
                    z(e)
                }
                ))
            }
        ...
        var X = Object(r.forwardRef)((function(e, t) {
            ...
            i.a.createElement(r.Fragment, null, n(W({}, c, {
                open: a
            })))
        }
        ));
        ...
        function H() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              ...
              , O = e.onDropAccepted
              , w = e.onDropRejected
              , j = e.onFileDialogCancel
              , D = e.preventDropOnDocument
              , A = void 0 === D || D
              , F = e.noClick
              , E = void 0 !== F && F
              , k = e.noKeyboard
              ...
              , I = e.noDrag
              , K = void 0 !== I && I
              , q = e.noDragEventsBubbling
              , X = void 0 !== q && q
              , H = Object(r.useRef)(null)
              , U = Object(r.useRef)(null)
              , V = Object(r.useReducer)(Q, $)
              , Y = G(V, 2)
              , Z = Y[0]
              , ee = Y[1]
              , te = Z.isFocused
              , ne = Z.isFileDialogActive
              , re = Z.draggedFiles
              ...
              , oe = function() {
                ne && setTimeout((function() {
                    U.current && (U.current.files.length || (ee({
                        type: "closeDialog"
                    }),
                    "function" == typeof j && j()))
                }
            ...
            Object(r.useEffect)((function() {
                return window.addEventListener("focus", oe, !1),
                function() {
                    window.removeEventListener("focus", oe, !1)
                }
            }
            ), [U, ne, j]);
            var ae = Object(r.useCallback)((function(e) {
                H.current && H.current.isEqualNode(e.target) && (32 !== e.keyCode && 13 !== e.keyCode || (e.preventDefault(),
                ie()))
            }
            ), [H, U])
              ...
              , ue = Object(r.useCallback)((function() {
                ee({
                    type: "blur"
                })
            }
              ...
              , le = Object(r.useCallback)((function() {
                E || (B() ? setTimeout(ie, 0) : ie())
            }
            ), [U, E])
              , se = Object(r.useRef)([])
              , fe = function(e) {
                H.current && H.current.contains(e.target) || (e.preventDefault(),
                se.current = [])
            };
            Object(r.useEffect)((function() {
                return A && (document.addEventListener("dragover", L, !1),
                document.addEventListener("drop", fe, !1)),
                function() {
                    A && (document.removeEventListener("dragover", L),
            ...
            var pe = Object(r.useCallback)((function(e) {
                ...
                e.persist(),
                he(e),
                se.current = [].concat(N(se.current), [e.target]),
                T(e) && Promise.resolve(a(e)).then((function(t) {
                    z(e) && !X || (ee({
                        draggedFiles: t,
                        isDragActive: !0,
              ...
              , ve = Object(r.useCallback)((function(e) {
                ...
                e.persist(),
                he(e);
                var t = se.current.filter((function(e) {
              ...
              , ge = Object(r.useCallback)((function(e) {
                e.preventDefault(),
                e.persist(),
                he(e),
                se.current = [],
                T(e) && Promise.resolve(a(e)).then((function(n) {
                    if (!z(e) || X) {
                        var r = []
                          , i = [];
                        ...
                        (!d && r.length > 1 || d && g >= 1 && r.length > g) && (r.forEach((function(e) {
                            i.push({
                                file: e,
                                errors: [P]
                            })
              ...
              , Oe = Object(r.useMemo)((function() {
                return function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                      ...
                      , s = e.onDragLeave
                      , f = e.onDrop
                      , p = J(e, ["refKey", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"]);
                    return W(_({
                        onKeyDown: be(M(r, ae)),
                        onFocus: be(M(o, ce)),
                        onBlur: be(M(a, ue)),
                        onClick: ye(M(c, le)),
                        onDragEnter: me(M(u, pe)),
                        onDragOver: me(M(l, de)),
                        onDragLeave: me(M(s, ve)),
                        onDrop: me(M(f, ge))
                    }, n, H), i || x ? {} : {
                        tabIndex: 0
                    }, {}, p)
            ...
            ), [H, ae, ce, ue, le, pe, de, ve, ge, x, K, i])
              , we = Object(r.useCallback)((function(e) {
                e.stopPropagation()
            }
            ), [])
        ...
        t.default = function() {
            var e = Object(r.useRef)(null)
              ...
              , s = H({
                onDrop: Object(r.useCallback)((function(e) {
                    o(!0);
                    var t = e.shift();
                    l(t)
                }
            ...
            return i.a.createElement(V.a, {
                ...
                className: "viewer",
                ref: e
            }, !n && i.a.createElement("div", Object.assign({
                className: "dnd"
            }, f()), i.a.createElement("input", p()), !d && i.a.createElement("h1", null, "생활기록부 hwp 파일을 드래그 & 드랍해 주세요")), c && i.a.createElement("div", null, i.a.createElement("h1", null, "에러가 발생했습니다"), i.a.createElement("p", null, c))))
        }
    },
    X1Co: function(e, t, n) {
        "use strict";
