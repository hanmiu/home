...
<table>
    ...
    if(document.querySelector('#pages').children.length > 0) {
        document.querySelector('#pages').appendChild(document.createElement('hr'));
    }

    document.querySelector('#pages').appendChild(el_page);

    if(document.querySelector('#pages').children.length === 1) {
        el_page.style.marginTop = document.querySelector('#ui').getBoundingClientRect().height + 50 + 'px';
    }
}