html['parent'] = `
  ...
  <br>
  <div class="subtle">
  공유 모임을 통해 교실의 놀이 이야기를 가정과 공유합니다. 부모가 서로 교제하는 시간, 교사의 발표, 워크숍 등이 혼합되어 진행되는 공유 모임은 준비하는 과정에서 교사가 수업을 회고하며 의미를 되새기는 경험을 장려하고 사전 교사 협의를 통해 교육 과정을 조정하는 장학의 역할을 합니다. 공유(부모, 다른 교사)를 통해 피드백을 주고 받으며 어린이의 놀이를 지원할 수 있는 새로운 아이디어를 얻습니다. 2020학년도는 코로나19 상황으로 &lt;비대면&gt; 방식(1학기는 영상, 2학기는 Zoom)으로 이루어졌습니다.
  </div>
  <br>
